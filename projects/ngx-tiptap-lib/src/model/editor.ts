...
import {camelCase, injectCSS} from '../utils/css.util';
import {Doc} from '../extension/basic/doc';
import {Text} from '../extension/basic/text';
import {Paragraph} from '../extension/basic/paragraph';
...
import markIsActive, { getMarkAttrs } from '../utils/mark.util';
import nodeIsActive, { getNodeAttrs } from '../utils/node.util';
export class NgxTipTapEditor extends Emitter {
  defaultOptions: any;
  events: any;
  focused = false;
  selection: any;
